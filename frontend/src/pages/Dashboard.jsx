...
import { TrendingUp, Zap, Mail } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="text-center py-6">
        ...
        <div className="flex items-center justify-center gap-4 mt-4 text-sm text-gray-500">
          <div className="flex items-center gap-1.5"><TrendingUp className="w-4 h-4 text-red-400" /> Viral Titles</div>
          ...
          {!content && !isGenerating && (
            <div className="card p-12 flex flex-col items-center justify-center text-center h-full min-h-[400px]">
              ...
              <p className="text-gray-600 text-sm max-w-xs">
                Enter your channel name on the left and click Generate to get your complete content package.
              </p>
            </div>
          )}
